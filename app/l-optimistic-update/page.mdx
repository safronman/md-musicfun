...
- если вдруг во время запроса пойдет не так, тогда изменения на `UI` откатятс на предыдущее значение 🚀

### selectCachedArgsForQuery

Если перейти на другую страницу плейлистов, то `optimistic update` не работает 😢
