...
После мутации данных на `UI` не видно изменений без перегрузки страницы.
...
<Callout type={'info'}>
  ...
  При инвалидации кэш-тега `RTK Query` автоматически повторно запрашивает данные с помощью эндпоинтов, помеченных этим
  тегом:
