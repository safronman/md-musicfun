...
[Мутации](https://redux-toolkit.js.org/rtk-query/usage/mutations) используются для обновлений данных на сервере и в кеше на клиенте. При успешном выполнении
...
Эта ошибка означает, что создавать плейлисты может только авторизованный пользователь. Чтобы бекенд понял, кто к нему
